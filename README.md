📊 Sales Analytics & CRM Optimization Project
📌 Overview

This project focuses on analyzing sales performance and customer behavior to generate actionable insights for improving revenue and customer retention. Using SQL and Power BI, the project uncovers patterns in deal success, pipeline efficiency, churn risk, and seasonal sales trends.

🎯 Objectives
Analyze sales performance to identify top agents, products, and high-value deals
Understand deal success & failure factors and improve conversion rates
...
Deal details (won/lost, revenue, deal stage)
...
Identified bottlenecks by analyzing deal movement across stages
Average Deal Closing Time
Calculated time taken to close deals across industries
Churn Risk Analysis
...
Stage-wise conversion rates and drop-offs
Revenue Trends
Monthly trends with forecasting
Sales Agent Performance
Ranking based on revenue and win rate
Product Performance
